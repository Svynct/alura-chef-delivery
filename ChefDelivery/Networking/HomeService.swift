...
struct HomeService {
    func fetchData() async throws -> Result<[StoreType], RequestError> {
        guard let url = URL(string: "https://private-696f4a-ricardoamaral.apiary-mock.com/home") else { 
    ...
    func fetchDataWithAlamofire(completion: @escaping ([StoreType]?, Error?) -> Void) {
        AF.request("https://private-696f4a-ricardoamaral.apiary-mock.com/home").responseDecodable(of: [StoreType].self) { response in
